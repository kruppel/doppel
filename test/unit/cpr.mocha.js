...
describe('[unit] cpr', function () {
  ...
  describe('async', function () {
    ...
    describe('when source directory exists', function () {
      ...
      describe('and destination directory is the same', function () {

        it('calls back with error', function (done) {
          cpr.cpr(this.src, this.src, function () {
            [].slice.call(arguments)[0].message.should.equal(
              format(
      ...
      describe('and destination directory is not the same', function () {

        describe('and destination directory removal fails', function () {
        ...
        describe('and destination directory removal succeeds', function () {
